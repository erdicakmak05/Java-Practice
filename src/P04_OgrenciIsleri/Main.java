...
public class Main {
	...
	public static void main(String[] args) {
		...
		Ogrenci ogr1 = new Ogrenci(0,"Erdi", "Çakmak", 15.5);
		ogrenciListesi.add(ogr1);

		Ogrenci ogr2 = new Ogrenci(0,"Hasan", "Çelik", 60.5);
		ogrenciListesi.add(ogr2);

		Ogrenci ogr3 = new Ogrenci(0,"Kadir", "Durmaz",15.5);
	...
	private static void ogrenciKaydıYap() {
		...
		Ogrenci obj = new Ogrenci(ogrNo,ad, soyad, ortalama);
